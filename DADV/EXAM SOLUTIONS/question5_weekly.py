...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan  2 13:08:04 2021
...
def first():
    ...
    plt.savefig(spark_path + "weekly.png")
    ...
    pdf.image(spark_path + 'weekly.png', x = None, y = None, w = 200, h = 150, type = '', link = '')
    pdf.output(spark_path+ 'weekly.pdf', 'F')

    
    return render_template('test1.html', hist_url = 'spark_weekly.png')
