...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan  2 12:02:49 2021
...
plt.savefig(spark_path + "spark_weekly.png")
...
pdf.image(spark_path + 'spark_weekly.png', x = None, y = None, w = 200, h = 150, type = '', link = '')
pdf.output(spark_path+ 'sparkline_weekly.pdf', 'F')
